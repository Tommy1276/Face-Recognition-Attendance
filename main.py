...
# Compares two images (Modi) and shows similarity
...
encodeTest = face_recognition.face_encodings(imgTest)[0]   # ✅ Fixed here
...
print("Match Result:", results, " | Face Distance:", faceDis)
